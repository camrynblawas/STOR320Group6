...
We can see that from the table, the best model that gives a lowest false positive rate is `bestglm.mod5`, with the following predictors: 
...
model5.res= resid(last.model)
ggplot(data=prediction, aes(x=PlaceStatus, y= model5.res))+
  geom_jitter()+
  geom_hline(yintercept=0)+
  ggtitle("Residuals Plot of Model 5")+
  xlab("Actual Values")+
  ylab("Residuals")
